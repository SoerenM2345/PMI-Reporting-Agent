...
DST = Path("/sessions/inspiring-great-ptolemy/mnt/02_Sommer 26--PMI/GIT/"
           "PMI-Reporting_Agent/Syntetic_data_with_errors")
A = "Arial"
...
ROWS = [
    ("E-01", "Corrupted file", "Blocking",
     ...
     "it was empty",
     "Compare with the same file in Syntetic_data"),
...
ws["A2"] = ("10 deliberate flaws injected into a copy of the clean corpus. "
            "Reference corpus: ../Syntetic_data. Everything not listed here is identical "
